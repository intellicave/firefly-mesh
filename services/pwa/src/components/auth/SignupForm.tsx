      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-background px-2 text-muted-foreground">{t("signup_or")}</span>
          </div>
        </div>

        <form onSubmit={handleEmailSignUp} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="name">{t("signup_label_name")}</Label>
            <Input
              id="name"
              type="text"
          ...
          <div className="space-y-2">
            <Label htmlFor="email">{t("signup_label_email")}</Label>
            <Input
              id="email"
              type="email"
          ...
          <div className="space-y-2">
            <Label htmlFor="password">{t("signup_label_password")}</Label>
            <Input
              id="password"
              type="password"
